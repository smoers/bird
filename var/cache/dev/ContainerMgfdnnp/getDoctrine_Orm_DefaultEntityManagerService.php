...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/ORG/BirdBundle/Entity'))), 'ORG\\BirdBundle\\Entity');
...
$b->setEntityNamespaces(array('ORGBirdBundle' => 'ORG\\BirdBundle\\Entity'));
