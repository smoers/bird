...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'monolog.handler.bird' => 'getMonolog_Handler_BirdService',
        ...
        $this->fileMap = array(
            ...
            'assetic.controller' => __DIR__.'/getAssetic_ControllerService.php',
            ...
            'monolog.logger.bird' => __DIR__.'/getMonolog_Logger_BirdService.php',
            ...
            'security.authentication.listener.anonymous.main_login' => __DIR__.'/getSecurity_Authentication_Listener_Anonymous_MainLoginService.php',
            'security.authentication.listener.form.main' => __DIR__.'/getSecurity_Authentication_Listener_Form_MainService.php',
            'security.authentication.provider.anonymous.main_login' => __DIR__.'/getSecurity_Authentication_Provider_Anonymous_MainLoginService.php',
            ...
            'security.firewall.map.context.main_login' => __DIR__.'/getSecurity_Firewall_Map_Context_MainLoginService.php',
            ...
            'security.request_matcher.ialwp3p' => __DIR__.'/getSecurity_RequestMatcher_Ialwp3pService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1HWGFgGSBd', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0jVkwStezC', 0, '1TQ-yCq6TlrSpMZkFAuHXH', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R4n6doPCn4', 0, '1TQ-yCq6TlrSpMZkFAuHXH', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZwBUBfQUhv', 0, '1TQ-yCq6TlrSpMZkFAuHXH', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gGWxY-mmpg', 0, '1TQ-yCq6TlrSpMZkFAuHXH', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e99d17d859ad7f89871af30e1c01b74e54fffe4a')) && false ?: '_'}, '/_fragment');
    }
    ...
    /**
     * Gets the private 'monolog.handler.bird' shared service.
     *
     * @return \Monolog\Handler\RotatingFileHandler
     */
    protected function getMonolog_Handler_BirdService()
    {
        $this->services['monolog.handler.bird'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/logs/bird/dev.log'), 5, 100, true, NULL);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.dev' => function () {
            ...
            return ${($_ = isset($this->services['security.firewall.map.context.main_login']) ? $this->services['security.firewall.map.context.main_login'] : $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_MainLoginService.php')) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/ORG/BirdBundle/Resources/views'), 'ORGBird');
        $instance->addPath(($this->targetDirs[3].'/src/ORG/BirdBundle/Resources/views'), '!ORGBird');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e99d17d859ad7f89871af30e1c01b74e54fffe4a');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ORGBirdBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ORG/BirdBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ORGBirdBundle' => 'ORG\\BirdBundle\\ORGBirdBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'bird',
            'database_user' => 'bird_user',
            'database_password' => 'Garion01',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'serge.moers@gmail.com',
            'mailer_password' => NULL,
            'secret' => 'e99d17d859ad7f89871af30e1c01b74e54fffe4a',
            'images_authors_folder' => 'images/authors/',
            'images_books_folder' => 'images/books/',
            'choice_authors' => 'extend.field.choice.author.',
            'choice_cycles' => 'extend.field.choice.cycle.',
            'choice_books' => 'extend.field.choice.book.',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e99d17d859ad7f89871af30e1c01b74e54fffe4a',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'serge.moers@gmail.com',
            ...
            'fos_user.model.user.class' => 'ORG\\BirdBundle\\Entity\\Security\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'serge.moers@gmail.com' => 'serge.moers@gmail.com',
            ),
            ...
            'fos_user.model.group.class' => 'ORG\\BirdBundle\\Entity\\Security\\Group',
