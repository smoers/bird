 ...
 * ExtendValuesBook
 *
 * @ORM\Table(name="extend_values_book")
 * @ORM\Entity(repositoryClass="ORG\BirdBundle\Repository\ExtendValuesBookRepository")
 */
class ExtendValuesBook
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\OneToOne(targetEntity="ORG\BirdBundle\Entity\LinkFieldsBook", cascade={"persist"})
     * @ORM\JoinColumns({
     *	 @ORM\JoinColumn(name="link_extend_book_id", referencedColumnName="id", onDelete="CASCADE")
     * })

     */
    private $linkExtendBook;
    ...
    public function getLinkExtendBook() {
        return $this->linkExtendBook;
    }
    public function setLinkExtendBook($linkExtendBook) {
        $this->linkExtendBook = $linkExtendBook;
        return $this;
    }
}
